...
export default function TruncationWidget({ truncationRisk, metrics, mode }) {
  ...
  return (
    ...
    >
      <div
        className={`bg-slate-900/95 backdrop-blur-sm text-white rounded-xl shadow-2xl pointer-events-auto border border-slate-700 ${
          isExpanded ? "w-72 p-4 max-h-[400px] overflow-y-auto" : "w-auto px-4 py-2"
